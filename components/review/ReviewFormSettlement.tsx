  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleFieldChange('gross_sales_total', parseFloat(e.target.value) || 0)}
              disabled={readOnly}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleFieldChange('sales_tax_total', parseFloat(e.target.value) || 0)}
              disabled={readOnly}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleFieldChange('credit_card_fees', parseFloat(e.target.value) || 0)}
              disabled={readOnly}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleFieldChange('other_fees', parseFloat(e.target.value) || 0)}
              placeholder="0.00"
              disabled={readOnly}
            />
          </div>
          ...
          {/* Net Settlement Amount (Calculated) */}
          <div>
      ...
      <div className="g-card p-4 bg-black/20">
        <h4 className="text-sm font-semibold text-[var(--g-text-dim)] mb-3">Settlement Calculation</h4>
